...
" License:      Same as Vim
" Last Updated: Sat Feb 26 15:26:01 2022
...
hi StatusLine guifg=#0000ee guibg=#ffffff gui=bold,reverse cterm=reverse
...
if s:t_Co >= 256
  ...
  hi StatusLine ctermfg=20 ctermbg=231 cterm=reverse
...
if s:t_Co >= 16
  ...
  hi StatusLine ctermfg=darkblue ctermbg=white cterm=reverse
