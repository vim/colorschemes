...
" Last Updated: Mon 06 Mar 2023 08:59:36 AM CET
...
hi CurSearch guifg=#ff87ff guibg=#000000 gui=reverse cterm=reverse
...
hi QuickFixLine guifg=#ff87ff guibg=#000000 gui=reverse cterm=reverse
hi Search guifg=#5fafff guibg=#000000 gui=reverse cterm=reverse
...
hi VertSplit guifg=#8787af guibg=NONE gui=NONE cterm=NONE
hi Visual guifg=#ffaf5f guibg=#000000 gui=reverse cterm=reverse
hi VisualNOS guifg=NONE guibg=#303030 gui=NONE cterm=NONE
hi WarningMsg guifg=#dadada guibg=NONE gui=NONE cterm=NONE
hi WildMenu guifg=#5fafff guibg=#000000 gui=bold cterm=bold
...
hi Todo guifg=#5fffaf guibg=NONE gui=bold,reverse cterm=bold,reverse
...
if s:t_Co >= 256
  ...
  hi CurSearch ctermfg=213 ctermbg=16 cterm=reverse
  ...
  hi QuickFixLine ctermfg=213 ctermbg=16 cterm=reverse
  hi Search ctermfg=75 ctermbg=16 cterm=reverse
  ...
  hi Todo ctermfg=85 ctermbg=NONE cterm=bold,reverse
