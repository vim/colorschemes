" Name:         morning
" Description:  Remake of default morning colorscheme.
" Author:       Updated by Maxim Kim <habamax@gmail.com>
" Maintainer:   Originally maintained by Bram Moolenaar <Bram@vim.org>
" License:      Vim License (see `:help license`)
" Last Updated: 29.09.2020 11:59:15
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi StatuslineTermNC guifg=#2e8b57 guibg=NONE gui=reverse cterm=reverse
  ...
  hi CursorLineNr guifg=NONE guibg=#d3d3d3 gui=NONE cterm=NONE
  ...
  hi ColorColumn guifg=NONE guibg=#d7ffff gui=NONE cterm=NONE
  hi Cursor guifg=#e4e4e4 guibg=#000000 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi StatuslineTermNC ctermfg=29 ctermbg=NONE cterm=reverse
  ...
  hi ColorColumn ctermfg=NONE ctermbg=195 cterm=NONE
  hi Cursor ctermfg=254 ctermbg=16 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi StatuslineTermNC ctermfg=2 ctermbg=NONE cterm=reverse
  hi VertSplit ctermfg=NONE ctermbg=NONE cterm=reverse
  ...
  hi ColorColumn ctermfg=NONE ctermbg=11 cterm=NONE
  hi Cursor ctermfg=7 ctermbg=0 cterm=NONE
  hi lCursor ctermfg=0 ctermbg=4 cterm=NONE
...
" Color: cursor      #00ff00 46  10
" Color: lcursor     #00ffff 51  11
