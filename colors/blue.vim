...
" License:      Same as Vim
" Last Updated: Sat Feb 19 11:34:33 2022
...
hi SpellLocal guifg=#000000 guibg=#008787 gui=undercurl cterm=underline
hi SpellRare guifg=#000000 guibg=#d787d7 gui=undercurl cterm=underline
...
if s:t_Co >= 256
  ...
  hi SpellLocal ctermfg=16 ctermbg=30 cterm=underline
  hi SpellRare ctermfg=16 ctermbg=176 cterm=underline
...
if s:t_Co >= 16
  ...
  hi SpellLocal ctermfg=black ctermbg=darkcyan cterm=underline
  hi SpellRare ctermfg=black ctermbg=magenta cterm=underline
