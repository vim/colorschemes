...
" Last Updated: 18.11.2020 17:46:12
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#ffdab9', '#a52a2a', '#c00058', '#cd00cd',
        \ '#008b8b', '#2e8b57', '#6a5acd', '#737373', '#406090', '#a52a2a',
        \ '#c00058', '#cd00cd', '#008b8b', '#2e8b57', '#6a5acd', '#000000']
  ...
  hi PmenuSbar guifg=NONE guibg=#e3c1a5 gui=NONE cterm=NONE
  hi PmenuThumb guifg=NONE guibg=#f5c195 gui=NONE cterm=NONE
  hi TabLine guifg=#000000 guibg=#737373 gui=underline cterm=underline
...
if s:t_Co >= 256
  ...
  hi TabLine ctermfg=16 ctermbg=243 cterm=underline
