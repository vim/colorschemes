...
" Authors:      Original author David Ne\v{c}as (Yeti) <yeti@physics.muni.cz>
" Maintainers:  Original maintainer David Ne\v{c}as (Yeti) <yeti@physics.muni.cz>
...
hi Normal guifg=#000000 guibg=#ffdab9 guisp=NONE gui=NONE
hi ColorColumn guifg=NONE guibg=#eeeeee guisp=NONE gui=NONE
hi Comment guifg=#406090 guibg=NONE guisp=NONE gui=NONE
hi Conceal guifg=#406090 guibg=NONE guisp=NONE gui=NONE
hi Constant guifg=#c00058 guibg=NONE guisp=NONE gui=NONE
hi Cursor guifg=#ffdab9 guibg=#000000 guisp=NONE gui=NONE
hi CursorColumn guifg=NONE guibg=#f5c195 guisp=NONE gui=NONE
hi CursorLine guifg=NONE guibg=#f5c195 guisp=NONE gui=NONE
hi CursorLineNr guifg=#cd0000 guibg=NONE guisp=NONE gui=bold
...
hi EndOfBuffer guifg=#737373 guibg=NONE guisp=NONE gui=NONE
hi Error guifg=#ff0000 guibg=#ffffff guisp=NONE gui=bold,reverse
hi ErrorMsg guifg=#ff0000 guibg=#ffffff guisp=NONE gui=bold,reverse
hi FoldColumn guifg=#406090 guibg=NONE guisp=NONE gui=NONE
hi Folded guifg=#000000 guibg=#e3c1a5 guisp=NONE gui=NONE
...
hi LineNr guifg=#cd0000 guibg=NONE guisp=NONE gui=NONE
hi MatchParen guifg=#ffdab9 guibg=#6a5acd guisp=NONE gui=NONE
hi ModeMsg guifg=#000000 guibg=#ffdab9 guisp=NONE gui=bold
hi MoreMsg guifg=#2e8b57 guibg=#ffdab9 guisp=NONE gui=bold
hi NonText guifg=#737373 guibg=NONE guisp=NONE gui=NONE
hi Pmenu guifg=#000000 guibg=#ffaf87 guisp=NONE gui=NONE
hi PmenuSbar guifg=NONE guibg=#ffdab9 guisp=NONE gui=NONE
hi PmenuSel guifg=#000000 guibg=#f5c195 guisp=NONE gui=bold
hi PmenuThumb guifg=NONE guibg=#737373 guisp=NONE gui=NONE
hi PreProc guifg=#cd00cd guibg=NONE guisp=NONE gui=NONE
hi Question guifg=#c00058 guibg=NONE guisp=NONE gui=bold
hi QuickFixLine guifg=#000000 guibg=#ffaf87 guisp=NONE gui=NONE
hi Search guifg=#ffdab9 guibg=#cd00cd guisp=NONE gui=NONE
hi SignColumn guifg=NONE guibg=NONE guisp=NONE gui=NONE
hi Special guifg=#6a5acd guibg=NONE guisp=NONE gui=NONE
hi SpecialKey guifg=#737373 guibg=NONE guisp=NONE gui=NONE
...
hi SpellLocal guifg=#cd00cd guibg=NONE guisp=#cd00cd gui=undercurl
hi SpellRare guifg=#6a5acd guibg=NONE guisp=#6a5acd gui=undercurl
hi Statement guifg=#a52a2a guibg=NONE guisp=NONE gui=bold
hi StatusLine guifg=#ffffff guibg=#000000 guisp=NONE gui=bold
hi StatusLineNC guifg=#ffdab9 guibg=#737373 guisp=NONE gui=bold
hi StatusLineTerm guifg=#ffffff guibg=#2e8b57 guisp=NONE gui=bold
hi StatusLineTermNC guifg=#ffdab9 guibg=#008b8b guisp=NONE gui=bold
hi TabLine guifg=#ffdab9 guibg=#737373 guisp=NONE gui=underline
hi TabLineFill guifg=NONE guibg=NONE guisp=NONE gui=reverse
hi TabLineSel guifg=#000000 guibg=#ffdab9 guisp=NONE gui=bold
hi Title guifg=#cd00cd guibg=NONE guisp=NONE gui=bold
hi Todo guifg=#6a5acd guibg=#ffff00 guisp=NONE gui=NONE
hi ToolbarButton guifg=#ffdab9 guibg=#737373 guisp=NONE gui=bold
...
hi VertSplit guifg=#ffdab9 guibg=#737373 guisp=NONE gui=NONE
hi Visual guifg=#000000 guibg=#cccccc guisp=NONE gui=NONE
hi VisualNOS guifg=NONE guibg=#406090 guisp=NONE gui=NONE
hi WarningMsg guifg=#cd00cd guibg=#ffdab9 guisp=NONE gui=bold
hi WildMenu guifg=#000000 guibg=#ffff00 guisp=NONE gui=bold
hi lCursor guifg=#000000 guibg=#c00058 guisp=NONE gui=NONE
