...
" License:      Same as Vim
" Last Updated: Fri 26 Jul 2024 04:08:52 PM AEST
...
hi Search guifg=#5faf5f guibg=#1c1c1c gui=reverse cterm=reverse
...
hi DiffAdd guifg=#5f87af guibg=NONE gui=reverse cterm=reverse
hi DiffChange guifg=#af87af guibg=NONE gui=reverse cterm=reverse
hi DiffText guifg=#5f87af guibg=NONE gui=reverse cterm=reverse
...
if s:t_Co >= 256
  ...
  hi Search ctermfg=71 ctermbg=234 cterm=reverse
  ...
  hi DiffAdd ctermfg=67 ctermbg=NONE cterm=reverse
  hi DiffChange ctermfg=139 ctermbg=NONE cterm=reverse
  hi DiffText ctermfg=67 ctermbg=NONE cterm=reverse
...
if s:t_Co >= 16
  ...
  hi DiffAdd ctermfg=darkblue ctermbg=NONE cterm=reverse
  hi DiffChange ctermfg=darkmagenta ctermbg=NONE cterm=reverse
  hi DiffText ctermfg=darkblue ctermbg=NONE cterm=reverse
...
" Color: diffChange       #af87af        139            darkmagenta
