...
" License:      Same as Vim
" Last Updated: Sun 07 Jul 2024 16:21:24
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#af5f5f', '#5faf5f', '#af875f', '#5f87af', '#af87af', '#5f8787', '#9e9e9e', '#767676', '#d75f87', '#87d787', '#d7af87', '#87afd7', '#d7afd7', '#87afaf', '#bcbcbc']
endif
...
hi Title guifg=#d7af87 guibg=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi Title ctermfg=180 ctermbg=NONE cterm=bold
