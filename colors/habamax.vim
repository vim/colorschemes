...
" License:      Same as Vim
" Last Updated: Fri 05 Jul 2024 04:48:34 PM AEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#1c1c1c', '#d75f5f', '#5faf5f', '#afaf87', '#5f87af', '#af87af', '#5f8787', '#9e9e9e', '#767676', '#d7875f', '#87d787', '#d7d787', '#87afd7', '#d7afd7', '#87afaf', '#bcbcbc']
endif
...
hi PmenuMatchSel guifg=#af5f00 guibg=#afaf87 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi PmenuMatchSel ctermfg=130 ctermbg=144 cterm=NONE
