...
" License:      Same as Vim
" Last Updated: Sun Feb 12 11:19:34 2023
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#0e0024', '#d7005f', '#5faf00', '#ffaf00', '#5f5fff', '#d700ff', '#5fd7ff', '#d7d5db', '#878092', '#ff5faf', '#87ff00', '#ffff5f', '#afafff', '#ffafff', '#87ffff', '#ffffff']
endif
...
hi IncSearch guifg=#ffffff guibg=#0e0024 gui=reverse cterm=reverse
...
hi StatusLineTerm guifg=#0e0024 guibg=#87ff00 gui=NONE cterm=NONE
...
hi DiffText guifg=#c6c6c6 guibg=#000000 gui=reverse cterm=reverse
...
if s:t_Co >= 256
  ...
  hi IncSearch ctermfg=231 ctermbg=16 cterm=reverse
  ...
  hi StatusLineTerm ctermfg=16 ctermbg=118 cterm=NONE
  ...
  hi DiffText ctermfg=251 ctermbg=16 cterm=reverse
...
" Term colors: black term1 darkgreen darkyellow term4 darkmagenta darkcyan neutral1
" Term colors: neutral3 red green yellow blue magenta cyan white
