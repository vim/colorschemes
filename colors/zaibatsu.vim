...
" Highlighting groups link definitions
...
" Main highlighting groups for GUI and 256 colors
...
" Highlighting for terminals with termguicolors or 256 colors
if s:tgc || s:t_Co >= 256
  finish
endif

" Highlighting for 16-color terminals
if s:t_Co >= 16
  hi! link PmenuExtraSel PmenuSel
  hi! link PmenuKindSel PmenuSel
...
" Highlighting for 8-color terminals
if s:t_Co >= 8
...
" Generic terminal attributes for low-color modes
if s:t_Co >= 0
