...
" Last Updated: Thu 24 Nov 2022 15:16:26 +05
...
if &background ==# 'dark'
  ...
  hi TabLineFill guifg=#a89984 guibg=#3c3836 gui=NONE cterm=NONE
  ...
  hi TabLine guifg=#7c6f64 guibg=#ebdbb2 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi TabLine ctermfg=137 ctermbg=237 cterm=NONE
    hi TabLineFill ctermfg=137 ctermbg=237 cterm=NONE
    hi TabLineSel ctermfg=187 ctermbg=237 cterm=NONE
    ...
    hi TabLine ctermfg=243 ctermbg=187 cterm=NONE
