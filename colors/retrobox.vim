...
" Last Updated: Tue 09 Jul 2024 12:57:09 PM AEST
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi StatusLine ctermfg=239 ctermbg=252 cterm=bold,reverse
    hi StatusLineNC ctermfg=237 ctermbg=102 cterm=reverse
    hi TabLine ctermfg=102 ctermbg=237 cterm=NONE
    hi TabLineFill ctermfg=252 ctermbg=237 cterm=NONE
