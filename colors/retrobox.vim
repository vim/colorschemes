...
" Last Updated: Thu 24 Nov 2022 10:34:43 +05
...
if &background ==# 'dark'
  ...
  hi StatusLineNC guifg=#3c3836 guibg=#7c6f64 gui=reverse cterm=reverse
  hi TabLine guifg=#7c6f64 guibg=#3c3836 gui=NONE cterm=NONE
  hi TabLineFill guifg=#7c6f64 guibg=#3c3836 gui=NONE cterm=NONE
  hi TabLineSel guifg=#fbf1c7 guibg=#1c1c1c gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi StatusLineNC ctermfg=237 ctermbg=243 cterm=reverse
