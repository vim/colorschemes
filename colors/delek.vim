...
" License:      Same as Vim
" Last Updated: Sat Feb 26 15:25:51 2022
...
hi StatusLine guifg=#0000ff guibg=#ffd700 gui=bold,reverse cterm=reverse
hi StatusLineNC guifg=#0000ff guibg=#ffd700 gui=reverse cterm=reverse
hi StatusLineTerm guifg=#0000ff guibg=NONE gui=bold,reverse cterm=reverse
...
hi WildMenu guifg=#ffd700 guibg=#00008b gui=bold cterm=NONE
...
if s:t_Co >= 256
  ...
  hi StatusLine ctermfg=21 ctermbg=220 cterm=reverse
  ...
  hi WildMenu ctermfg=220 ctermbg=18 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi StatusLine ctermfg=darkblue ctermbg=darkyellow cterm=reverse
  ...
  hi WildMenu ctermfg=darkyellow ctermbg=darkblue cterm=NONE
