" Name:         delek
" Description:  Reimplementation of default delek colorscheme
" Author:       Updated by Maxim Kim <habamax@gmail.com>
" Maintainer:   Originally mainatined by David Schweikert <david@schweikert.ch>
" License:      Vim License (see `:help license`)
" Last Updated: 14.11.2020 14:42:49
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Question guifg=#00cd00 guibg=NONE gui=NONE cterm=NONE
  ...
  hi SpellCap guifg=#00cd00 guibg=NONE guisp=#00cd00 gui=undercurl cterm=underline
