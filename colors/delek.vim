...
" License:      Same as Vim
" Last Updated: 26.02.2022 19:13:24
...
hi StatusLine guifg=#ffd700 guibg=#00008b gui=bold cterm=NONE
hi StatusLineNC guifg=#e4e4e4 guibg=#00008b gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi StatusLineNC ctermfg=254 ctermbg=18 cterm=NONE
...
if s:t_Co >= 16
  ...
  hi StatusLine ctermfg=darkyellow ctermbg=darkblue cterm=NONE
