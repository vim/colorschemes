...
" License:      Same as Vim
" Last Updated: Tue Jan 18 13:02:42 2022
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffText guifg=NONE guibg=#00cd00 gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=NONE ctermbg=40 cterm=bold
...
if s:t_Co >= 16
  ...
  hi DiffChange ctermfg=white ctermbg=darkmagenta cterm=NONE
  hi DiffDelete ctermfg=blue ctermbg=darkcyan cterm=NONE
  hi DiffText ctermfg=NONE ctermbg=darkgreen cterm=bold
