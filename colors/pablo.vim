...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi CursorLine guifg=NONE guibg=#3a3a3a gui=NONE cterm=underline
  hi CursorLineNr guifg=#ffff00 guibg=#3a3a3a gui=bold cterm=underline
...
if s:t_Co >= 256
  ...
  hi CursorLine ctermfg=NONE ctermbg=237 cterm=underline
  hi CursorLineNr ctermfg=226 ctermbg=237 cterm=underline
