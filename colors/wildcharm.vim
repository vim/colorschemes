...
" License:      Same as Vim
" Last Updated: Wed 03 Jan 2024 05:29:12 PM AEDT
...
if &background ==# 'dark'
  ...
  hi TabLineSel guifg=#d0d0d0 guibg=#000000 gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi TabLineSel ctermfg=252 ctermbg=16 cterm=bold
