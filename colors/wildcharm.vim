...
if &background == 'dark'
  ...
  hi DiffAdd guifg=NONE guibg=#002f00 guisp=NONE gui=NONE ctermfg=252 ctermbg=22 cterm=NONE term=reverse
  hi DiffChange guifg=NONE guibg=#2f2f2f guisp=NONE gui=NONE ctermfg=252 ctermbg=236 cterm=NONE term=NONE
  hi DiffDelete guifg=#767676 guibg=#3f1f00 guisp=NONE gui=NONE ctermfg=243 ctermbg=52 cterm=NONE term=reverse
  ...
  hi Search guifg=#00d75f guibg=#000000 guisp=NONE gui=reverse ctermfg=41 ctermbg=16 cterm=reverse term=reverse
  ...
  if s:t_Co >= 16
    ...
    hi DiffAdd ctermfg=grey ctermbg=darkgreen cterm=NONE
    hi DiffChange ctermfg=grey ctermbg=darkgray cterm=NONE
    hi DiffDelete ctermfg=darkgrey ctermbg=darkred cterm=NONE
    hi DiffText ctermfg=grey ctermbg=darkcyan cterm=NONE
...
if &background == 'light'
  ...
  hi Ignore guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=NONE
  hi IncSearch guifg=#d78700 guibg=#ffffff guisp=NONE gui=reverse ctermfg=172 ctermbg=231 cterm=reverse term=bold,reverse,underline
  ...
  hi Search guifg=#008700 guibg=#ffffff guisp=NONE gui=reverse ctermfg=28 ctermbg=231 cterm=reverse term=reverse
  hi SignColumn guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=reverse
