...
if &background == 'dark'
  ...
  hi Todo guifg=#875fff guibg=NONE guisp=NONE gui=bold ctermfg=99 ctermbg=NONE cterm=bold term=bold,reverse
...
if &background == 'light'
  ...
  hi Title guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold term=NONE
  hi Todo guifg=#5f00d7 guibg=NONE guisp=NONE gui=bold ctermfg=56 ctermbg=NONE cterm=bold term=bold,reverse
