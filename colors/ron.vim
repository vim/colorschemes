...
" License:      Same as Vim
" Last Updated: Sat Feb 19 11:20:53 2022
...
hi SpellBad guifg=#ffff00 guibg=#ff0000 gui=undercurl cterm=underline
hi SpellCap guifg=#ffff00 guibg=#0000ff gui=undercurl cterm=underline
hi SpellLocal guifg=#000000 guibg=#00ffff gui=undercurl cterm=underline
hi SpellRare guifg=#ffff00 guibg=#ff00ff gui=undercurl cterm=underline
...
if s:t_Co >= 256
  ...
  hi SpellBad ctermfg=226 ctermbg=196 cterm=underline
  hi SpellCap ctermfg=226 ctermbg=21 cterm=underline
  hi SpellLocal ctermfg=16 ctermbg=51 cterm=underline
  hi SpellRare ctermfg=226 ctermbg=201 cterm=underline
...
if s:t_Co >= 16
  ...
  hi SpellBad ctermfg=yellow ctermbg=red cterm=underline
  hi SpellCap ctermfg=yellow ctermbg=darkblue cterm=underline
  hi SpellLocal ctermfg=black ctermbg=cyan cterm=underline
  hi SpellRare ctermfg=yellow ctermbg=magenta cterm=underline
