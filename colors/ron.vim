...
hi VertSplit guifg=#00ffff guibg=#0000ff guisp=NONE gui=NONE ctermfg=51 ctermbg=21 cterm=NONE term=NONE
hi VertSplitNC guifg=#add8e6 guibg=#00008b guisp=NONE gui=NONE ctermfg=152 ctermbg=20 cterm=NONE term=NONE
...
if s:t_Co >= 16
  ...
  hi VertSplit ctermfg=cyan ctermbg=darkblue cterm=NONE
  hi VertSplitNC ctermfg=darkcyan ctermbg=darkblue cterm=NONE
...
if s:t_Co >= 8
  ...
  hi VertSplitNC ctermfg=darkblue ctermbg=darkblue cterm=NONE
  hi Visual ctermfg=NONE ctermbg=NONE cterm=reverse
  hi VisualNOS ctermfg=NONE ctermbg=black cterm=underline
