...
" Last Updated: Tue Dec  6 11:15:06 2022
...
if &background ==# 'dark'
  ...
  hi Pmenu guifg=#d0d0d0 guibg=#1c1c1c gui=NONE cterm=NONE
  ...
  hi DiffDelete guifg=#000000 guibg=#875f5f gui=NONE cterm=NONE
  hi DiffAdd guifg=NONE guibg=#1c3a1c gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#303030 gui=NONE cterm=NONE
  hi DiffText guifg=NONE guibg=#5f5f3f gui=NONE cterm=NONE
else
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffDelete guifg=#b79797 guibg=#ffe0e0 gui=NONE cterm=NONE
  hi DiffAdd guifg=NONE guibg=#d0dfd0 gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#dadada gui=NONE cterm=NONE
  hi DiffText guifg=NONE guibg=#f2dfaf gui=NONE cterm=NONE
endif
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi Pmenu ctermfg=252 ctermbg=234 cterm=NONE
    ...
    hi DiffDelete ctermfg=16 ctermbg=95 cterm=NONE
    hi DiffAdd ctermfg=157 ctermbg=65 cterm=NONE
    hi DiffChange ctermfg=252 ctermbg=59 cterm=NONE
    hi DiffText ctermfg=229 ctermbg=101 cterm=NONE
  else
    " Light background
    ...
    hi DiffDelete ctermfg=52 ctermbg=224 cterm=NONE
    hi DiffAdd ctermfg=22 ctermbg=151 cterm=NONE
    hi DiffChange ctermfg=235 ctermbg=253 cterm=NONE
    hi DiffText ctermfg=94 ctermbg=187 cterm=NONE
  endif
  unlet s:t_Co
  finish
endif
...
" Color: diffAdd                 #1C3A1C        65             darkmagenta
" Color: diffAddFg               #afffaf        157            black
" Color: diffDelete              #875f5f        95             darkred
" Color: diffDeleteFg            #000000        16             black
" Color: diffChange              #303030        59             lightgray
" Color: diffChangeFg            #d0d0d0        252            black
" Color: diffText                #5f5f3f        101            cyan
" Color: diffTextFg              #ffffaf        229            black
...
" Color: diffAdd                 #d0dfd0        151            darkmagenta
" Color: diffAddFg               #005f00        22             black
" Color: diffDelete              #ffe0e0        224            darkred
" Color: diffDeleteFg            #b79797        52             black
" Color: diffChange              #dadada        253            lightgray
" Color: diffChangeFg            #262626        235            black
" Color: diffText                #f2dfaf        187            cyan
" Color: diffTextFg              #875f00        94             black
" Term colors: color00 color01 color02 color03 color04 color05 color06 color07
" Term colors: color08 color09 color10 color11 color12 color13 color14 color15
" Background: any
" vim: et ts=2 sw=2
