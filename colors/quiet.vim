...
" Last Updated: 2022-08-03 11:57:09
...
if &background ==# 'dark'
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#080808', '#af0000', '#005f00', '#af5f00', '#005faf', '#870087', '#008787', '#dadada', '#626262', '#d70000', '#008700', '#d78700', '#0087d7', '#af00af', '#00afaf', '#ffffff']
  endif
  hi Normal guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi Terminal guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  ...
  hi DiffText guifg=#d787d7 guibg=#080808 gui=reverse cterm=reverse
  hi Directory guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi ErrorMsg guifg=#080808 guibg=#dadada gui=reverse cterm=reverse
  hi FoldColumn guifg=#626262 guibg=#dadada gui=NONE cterm=NONE
  hi Folded guifg=#626262 guibg=#dadada gui=NONE cterm=NONE
  hi IncSearch guifg=#ffaf00 guibg=#080808 gui=reverse cterm=reverse
  hi LineNr guifg=#a8a8a8 guibg=#dadada gui=NONE cterm=NONE
  hi MatchParen guifg=#ff00af guibg=#dadada gui=bold cterm=bold
  hi ModeMsg guifg=#080808 guibg=#dadada gui=bold cterm=bold
  hi MoreMsg guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  ...
  hi Question guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi QuickFixLine guifg=#d787d7 guibg=#080808 gui=reverse cterm=reverse
  hi Search guifg=#00afff guibg=#080808 gui=reverse cterm=reverse
  hi SignColumn guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi SpecialKey guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi SpellBad guifg=#af0000 guibg=#dadada guisp=#af0000 gui=undercurl cterm=underline
  hi SpellCap guifg=#005faf guibg=#dadada guisp=#005faf gui=undercurl cterm=underline
  hi SpellLocal guifg=#870087 guibg=#dadada guisp=#870087 gui=undercurl cterm=underline
  hi SpellRare guifg=#008787 guibg=#dadada guisp=#008787 gui=undercurl cterm=underline
  ...
  hi TabLineFill guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi TabLineSel guifg=#eeeeee guibg=#080808 gui=bold cterm=bold
  hi Title guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi VertSplit guifg=#626262 guibg=#dadada gui=NONE cterm=NONE
  hi Visual guifg=NONE guibg=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi VisualNOS guifg=NONE guibg=#eeeeee gui=NONE cterm=NONE
  hi WarningMsg guifg=#080808 guibg=#dadada gui=NONE cterm=NONE
  hi WildMenu guifg=#080808 guibg=#eeeeee gui=bold cterm=bold
  hi Comment guifg=#080808 guibg=#dadada gui=bold cterm=bold
  ...
  hi ToolbarButton guifg=#080808 guibg=#dadada gui=bold cterm=bold
endif
