...
" Last Updated: Sun 24 Jul 2022 09:33:42 AM CEST
...
if &background ==# 'dark'
  ...
  hi NonText guifg=#626262 guibg=#d7d7d7 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi NonText ctermfg=241 ctermbg=188 cterm=NONE
...
if s:t_Co >= 2
  ...
  hi TabLine cterm=bold,underline
