...
if &background == 'dark'
  ...
  hi CocSearch guifg=#ffd787 guibg=NONE guisp=NONE gui=NONE ctermfg=222 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi CurSearch guifg=#000000 guibg=#5fd75f guisp=NONE gui=NONE ctermfg=16 ctermbg=77 cterm=NONE term=reverse
  ...
  hi DiffAdd guifg=#c6c6c6 guibg=#875f87 guisp=NONE gui=NONE ctermfg=251 ctermbg=96 cterm=NONE term=reverse
  hi DiffChange guifg=#c6c6c6 guibg=#5f5f5f guisp=NONE gui=NONE ctermfg=251 ctermbg=59 cterm=NONE term=NONE
  hi DiffDelete guifg=#d78787 guibg=NONE guisp=NONE gui=NONE ctermfg=174 ctermbg=NONE cterm=NONE term=reverse
  hi DiffText guifg=#afffff guibg=#5f8787 guisp=NONE gui=NONE ctermfg=159 ctermbg=66 cterm=NONE term=reverse
  ...
  hi Error guifg=#ffffff guibg=#ff5f5f guisp=NONE gui=NONE ctermfg=231 ctermbg=203 cterm=NONE term=bold,reverse
  hi ErrorMsg guifg=#ffffff guibg=#ff5f5f guisp=NONE gui=NONE ctermfg=231 ctermbg=203 cterm=NONE term=bold,reverse
  hi FilterMenuDirectorySubtle guifg=#878787 guibg=NONE guisp=NONE gui=NONE ctermfg=102 ctermbg=NONE cterm=NONE term=NONE
  hi FilterMenuLineNr guifg=#878787 guibg=NONE guisp=NONE gui=NONE ctermfg=102 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi IncSearch guifg=#000000 guibg=#5fd75f guisp=NONE gui=NONE ctermfg=16 ctermbg=77 cterm=NONE term=bold,reverse,underline
  ...
  hi Removed guifg=#d78787 guibg=NONE guisp=NONE gui=NONE ctermfg=174 ctermbg=NONE cterm=NONE term=NONE
  hi Search guifg=#000000 guibg=#ffd787 guisp=NONE gui=NONE ctermfg=16 ctermbg=222 cterm=NONE term=reverse
  ...
  hi SpellLocal guifg=NONE guibg=NONE guisp=#5faf5f gui=undercurl ctermfg=77 ctermbg=NONE cterm=underline term=underline
  ...
  hi Todo guifg=#5fd7d7 guibg=#000000 guisp=NONE gui=reverse ctermfg=116 ctermbg=16 cterm=reverse term=bold,reverse
  ...
  hi Visual guifg=#ffffff guibg=#005f87 guisp=NONE gui=NONE ctermfg=231 ctermbg=24 cterm=NONE term=reverse
  ...
  hi diffSubname guifg=#ff87ff guibg=NONE guisp=NONE gui=NONE ctermfg=213 ctermbg=NONE cterm=NONE term=NONE
  hi dirFilterMenuBookmarkPath guifg=#878787 guibg=NONE guisp=NONE gui=NONE ctermfg=102 ctermbg=NONE cterm=NONE term=NONE
  hi dirFilterMenuHistoryPath guifg=#878787 guibg=NONE guisp=NONE gui=NONE ctermfg=102 ctermbg=NONE cterm=NONE term=NONE
...
if &background == 'light'
  ...
  hi CocSearch guifg=#af0000 guibg=NONE guisp=NONE gui=NONE ctermfg=124 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi CurSearch guifg=#000000 guibg=#87d787 guisp=NONE gui=NONE ctermfg=16 ctermbg=114 cterm=NONE term=reverse
  ...
  hi DiffAdd guifg=#000000 guibg=#d7afd7 guisp=NONE gui=NONE ctermfg=16 ctermbg=182 cterm=NONE term=reverse
  hi DiffChange guifg=#000000 guibg=#d0d0d0 guisp=NONE gui=NONE ctermfg=16 ctermbg=252 cterm=NONE term=NONE
  hi DiffDelete guifg=#870000 guibg=NONE guisp=NONE gui=NONE ctermfg=88 ctermbg=NONE cterm=NONE term=reverse
  hi DiffText guifg=#000000 guibg=#5fd7d7 guisp=NONE gui=NONE ctermfg=16 ctermbg=80 cterm=NONE term=reverse
  ...
  hi FilterMenuDirectorySubtle guifg=#626262 guibg=NONE guisp=NONE gui=NONE ctermfg=241 ctermbg=NONE cterm=NONE term=NONE
  hi FilterMenuLineNr guifg=#626262 guibg=NONE guisp=NONE gui=NONE ctermfg=241 ctermbg=NONE cterm=NONE term=NONE
  ...
  hi Identifier guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=NONE
  hi Ignore guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE term=NONE
  hi IncSearch guifg=#000000 guibg=#87d787 guisp=NONE gui=NONE ctermfg=16 ctermbg=114 cterm=NONE term=bold,reverse,underline
  ...
  hi TabLineFill guifg=NONE guibg=#767676 guisp=NONE gui=NONE ctermfg=NONE ctermbg=243 cterm=NONE term=NONE
  hi TabLineSel guifg=#ffffff guibg=#000000 guisp=NONE gui=bold,reverse ctermfg=231 ctermbg=16 cterm=bold,reverse term=bold,reverse
  hi Title guifg=NONE guibg=NONE guisp=NONE gui=bold ctermfg=NONE ctermbg=NONE cterm=bold term=NONE
  hi Todo guifg=#008787 guibg=#ffffff guisp=NONE gui=reverse ctermfg=30 ctermbg=231 cterm=reverse term=bold,reverse
  ...
  hi Underlined guifg=NONE guibg=NONE guisp=NONE gui=underline ctermfg=NONE ctermbg=NONE cterm=underline term=underline
  hi VertSplit guifg=#767676 guibg=#767676 guisp=NONE gui=NONE ctermfg=243 ctermbg=243 cterm=NONE term=NONE
  hi Visual guifg=#ffffff guibg=#5f87af guisp=NONE gui=NONE ctermfg=231 ctermbg=67 cterm=NONE term=reverse
  ...
  hi diffSubname guifg=#af00af guibg=NONE guisp=NONE gui=NONE ctermfg=127 ctermbg=NONE cterm=NONE term=NONE
