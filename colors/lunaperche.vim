...
" Last Updated: Sun 07 Jan 2024 20:12:58
...
if &background ==# 'dark'
  ...
  hi diffChanged guifg=#5fafff guibg=NONE gui=NONE cterm=NONE
  ...
  hi diffChanged guifg=#005fd7 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi diffChanged ctermfg=75 ctermbg=NONE cterm=NONE
    ...
    hi diffChanged ctermfg=26 ctermbg=NONE cterm=NONE
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi diffChanged ctermfg=darkblue ctermbg=NONE cterm=NONE
