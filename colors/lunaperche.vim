...
" Last Updated: Thu Aug 18 08:58:27 2022
...
if &background ==# 'dark'
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#af5f5f', '#5fd75f', '#af875f', '#5f87af', '#d787af', '#5fafaf', '#c6c6c6', '#767676', '#ff5f5f', '#87ff5f', '#ffd787', '#87afd7', '#ffafd7', '#5fd7d7', '#ffffff']
  endif
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#870000', '#008700', '#875f00', '#005faf', '#870087', '#008787', '#808080', '#626262', '#d70000', '#87d787', '#d7d787', '#0087d7', '#af00af', '#00afaf', '#ffffff']
  endif
  ...
  hi dirType guifg=#008787 guibg=NONE gui=NONE cterm=NONE
  ...
  hi dirSizeMod guifg=#008787 guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi dirType ctermfg=30 ctermbg=NONE cterm=NONE
    ...
    hi dirSizeMod ctermfg=30 ctermbg=NONE cterm=NONE
