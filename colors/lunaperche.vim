...
" Last Updated: Thu Aug 18 08:05:55 2022
...
if &background ==# 'dark'
  ...
  hi Special guifg=#767676 guibg=NONE gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#af0000', '#008700', '#875f00', '#005faf', '#870087', '#005f5f', '#808080', '#626262', '#d70000', '#87d787', '#d7d787', '#0087d7', '#af00af', '#008787', '#ffffff']
  endif
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi Special ctermfg=243 ctermbg=NONE cterm=NONE
