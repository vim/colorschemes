...
" Last Updated: Fri 02 Sep 2022 08:54:42 MSK
...
if &background ==# 'dark'
  ...
  hi CocPumShortcut guifg=NONE guibg=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
else
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi CocPumShortcut ctermfg=NONE ctermbg=NONE cterm=NONE
  else
    " Light background
