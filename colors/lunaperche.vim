...
" Last Updated: 2023-01-27 13:10:31
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    hi Conceal ctermfg=NONE ctermbg=NONE cterm=NONE
    hi Ignore ctermfg=NONE ctermbg=NONE cterm=NONE
    hi DiffAdd ctermfg=grey ctermbg=darkmagenta cterm=NONE
    hi DiffChange ctermfg=grey ctermbg=lightgray cterm=NONE
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi Ignore ctermfg=NONE ctermbg=NONE cterm=NONE
    hi DiffAdd ctermfg=grey ctermbg=darkmagenta cterm=NONE
    hi DiffChange ctermfg=grey ctermbg=darkcyan cterm=NONE
