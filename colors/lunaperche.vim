...
" Last Updated: Tue Aug 16 12:55:09 2022
...
if &background ==# 'dark'
  ...
  hi TabLine guifg=#000000 guibg=#585858 gui=NONE cterm=NONE
  ...
  hi PmenuSel guifg=#000000 guibg=#5fd75f gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#000000', '#870000', '#008700', '#875f00', '#005faf', '#870087', '#005f5f', '#808080', '#626262', '#d70000', '#5faf5f', '#d7d787', '#0087d7', '#af00af', '#5fafaf', '#ffffff']
  endif
  ...
  hi PmenuSel guifg=#ffffff guibg=#008700 gui=NONE cterm=NONE
  ...
  hi IncSearch guifg=#000000 guibg=#5faf5f gui=NONE cterm=NONE
  hi CurSearch guifg=#000000 guibg=#5faf5f gui=NONE cterm=NONE
  ...
  hi DiffChange guifg=#000000 guibg=#d0d0d0 gui=NONE cterm=NONE
  hi DiffText guifg=#000000 guibg=#bcbcbc gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  if &background ==# 'dark'
    ...
    hi TabLine ctermfg=16 ctermbg=240 cterm=NONE
    ...
    hi PmenuSel ctermfg=16 ctermbg=77 cterm=NONE
    ...
    hi PmenuSel ctermfg=231 ctermbg=28 cterm=NONE
    ...
    hi IncSearch ctermfg=16 ctermbg=71 cterm=NONE
    hi CurSearch ctermfg=16 ctermbg=71 cterm=NONE
...
" Color: diffChange              #D0D0D0        252            lightgray
" Color: diffText                #BCBCBC        250            darkgray
" Color: fgDiff                  #000000        16             black
" Term colors: color00 color01 color02 color03 color04 color05 color06 color07
" Term colors: color08 color09 color10 color11 color12 color13 color14 color15
" Background: any
