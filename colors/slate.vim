...
hi PmenuExtra guifg=#afaf87 guibg=#4a4a4a guisp=NONE gui=NONE ctermfg=144 ctermbg=239 cterm=NONE term=reverse
hi PmenuExtraSel guifg=#262626 guibg=#d7d787 guisp=NONE gui=NONE ctermfg=235 ctermbg=186 cterm=NONE term=NONE
hi PmenuKind guifg=#ffd700 guibg=#4a4a4a guisp=NONE gui=NONE ctermfg=220 ctermbg=239 cterm=NONE term=reverse
hi PmenuKindSel guifg=#262626 guibg=#d7d787 guisp=NONE gui=NONE ctermfg=235 ctermbg=186 cterm=NONE term=NONE
hi PmenuMatch guifg=#d7875f guibg=NONE guisp=NONE gui=bold ctermfg=173 ctermbg=NONE cterm=bold term=bold
hi PmenuMatchSel guifg=NONE guibg=#d7d787 guisp=NONE gui=bold ctermfg=NONE ctermbg=186 cterm=bold term=bold
...
if s:t_Co >= 16
  ...
  hi PmenuExtraSel ctermfg=black ctermbg=darkmagenta cterm=NONE
  hi PmenuKind ctermfg=NONE ctermbg=darkgrey cterm=NONE
  hi PmenuKindSel ctermfg=black ctermbg=darkmagenta cterm=NONE
