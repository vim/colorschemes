...
" License:      Same as Vim
" Last Updated: Wed Feb  2 23:01:46 2022
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffChange guifg=#87875f guibg=#000000 gui=reverse cterm=reverse
  hi DiffText guifg=#5faf5f guibg=#000000 gui=reverse cterm=reverse
  hi DiffDelete guifg=#5f8787 guibg=#000000 gui=reverse cterm=reverse
  unlet s:t_Co
  finish
endif
...
if s:t_Co >= 256
  ...
  hi DiffChange ctermfg=101 ctermbg=16 cterm=reverse
  hi DiffText ctermfg=71 ctermbg=16 cterm=reverse
  hi DiffDelete ctermfg=66 ctermbg=16 cterm=reverse
  unlet s:t_Co
  finish
endif
