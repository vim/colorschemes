...
" License:      Same as Vim
" Last Updated: Tue Jan 18 19:53:53 2022
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi DiffAdd guifg=#008700 guibg=#000000 gui=reverse cterm=reverse
  hi DiffChange guifg=#878700 guibg=#000000 gui=reverse cterm=reverse
  hi DiffText guifg=#00af00 guibg=#000000 gui=reverse cterm=reverse
  hi DiffDelete guifg=#008787 guibg=#000000 gui=reverse cterm=reverse
  unlet s:t_Co
  finish
endif
...
if s:t_Co >= 256
  ...
  hi DiffText ctermfg=28 ctermbg=235 cterm=reverse
...
if s:t_Co >= 16
  ...
  hi SpellBad ctermfg=NONE ctermbg=red cterm=undercurl
  hi SpellCap ctermfg=NONE ctermbg=darkblue cterm=undercurl
  hi SpellLocal ctermfg=NONE ctermbg=cyan cterm=undercurl
  hi SpellRare ctermfg=NONE ctermbg=magenta cterm=undercurl
  hi StatusLine ctermfg=darkblue ctermbg=white cterm=bold
  hi StatusLineNC ctermfg=white ctermbg=darkblue cterm=reverse
  ...
  hi Underlined ctermfg=blue ctermbg=NONE cterm=bold,underline
  hi CursorIM ctermfg=NONE ctermbg=fg cterm=NONE
  hi ToolbarLine ctermfg=NONE ctermbg=NONE cterm=NONE
...
" Color: bgDiffC     #878700        100            yellow
" Color: bgDiffD     #008787        30             darkcyan
" Color: bgDiffT     #00AF00        28             green
" Color: fgDiff      #000000        235            black
" vim: et ts=2 sw=2
