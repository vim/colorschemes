" Name:         unokai
" Description:  Color scheme similar to Monokai originally designed by Allan Odgaard for TextMate
...
hi Error guifg=#c61e5c guibg=#282923 gui=reverse cterm=reverse
hi ErrorMsg guifg=#c61e5c guibg=#282923 gui=reverse cterm=reverse
...
hi Title guifg=#f8f8f2 guibg=NONE gui=bold cterm=bold
...
if s:t_Co >= 256
  ...
  hi StatusLineNC ctermfg=235 ctermbg=242 cterm=NONE
  ...
  hi ToolbarButton ctermfg=242 ctermbg=255 cterm=bold,reverse
  ...
  hi Error ctermfg=125 ctermbg=235 cterm=reverse
  hi ErrorMsg ctermfg=125 ctermbg=235 cterm=reverse
...
" Color: color08               #74705d        242            darkgray
