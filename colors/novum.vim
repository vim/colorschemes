...
if s:t_Co >= 16
  ...
  hi CurSearch ctermfg=DarkGrey ctermbg=LightYellow cterm=NONE
  ...
  hi Folded ctermfg=DarkGrey ctermbg=DarkYellow cterm=NONE
  ...
  hi Search ctermfg=DarkGrey ctermbg=LightYellow cterm=NONE
  hi SignColumn ctermfg=DarkGrey ctermbg=NONE cterm=NONE
  hi Special ctermfg=LightCyan ctermbg=NONE cterm=NONE
  hi SpecialKey ctermfg=DarkGrey ctermbg=NONE cterm=NONE
  hi SpellBad ctermfg=LightGrey ctermbg=DarkGrey cterm=undercurl ctermul=Red
  hi SpellCap ctermfg=LightGrey ctermbg=DarkGrey cterm=undercurl ctermul=LightYellow
  hi SpellLocal ctermfg=LightGrey ctermbg=DarkGrey cterm=undercurl ctermul=LightGreen
  hi SpellRare ctermfg=LightGrey ctermbg=DarkGrey cterm=undercurl ctermul=LightCyan
  hi Statement ctermfg=LightGrey ctermbg=NONE cterm=bold
  hi StatusLine ctermfg=DarkGrey ctermbg=LightGrey cterm=bold,reverse
  ...
  hi ToolbarButton ctermfg=DarkYellow ctermbg=LightGrey cterm=bold
