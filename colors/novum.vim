...
if &background == 'dark'
  ...
  hi MatchParen guifg=#a6dbff guibg=#4f5258 guisp=NONE gui=bold ctermfg=153 ctermbg=59 cterm=bold term=bold,underline
  ...
  if s:t_Co >= 16
    ...
    hi MatchParen ctermfg=LightBlue ctermbg=DarkGray cterm=bold
...
if &background == 'light'
  ...
  hi MatchParen guifg=#004c73 guibg=#9b9ea4 guisp=NONE gui=bold ctermfg=24 ctermbg=145 cterm=bold term=bold,underline
  ...
  if s:t_Co >= 16
    ...
    hi LineNr ctermfg=DarkGray ctermbg=NONE cterm=NONE
    hi MatchParen ctermfg=DarkBlue ctermbg=DarkGray cterm=bold
