...
if s:t_Co >= 16
  ...
  hi StatusLine ctermfg=DarkGray ctermbg=LightGray cterm=NONE
...
if s:t_Co >= 8
  ...
  hi Cursor ctermfg=Black ctermbg=LightGray cterm=NONE
  hi CursorColumn ctermfg=LightGray ctermbg=DarkGray cterm=NONE
  hi CursorLine ctermfg=LightGray ctermbg=DarkGray cterm=NONE
  ...
  hi Special ctermfg=Cyan ctermbg=Black cterm=NONE
  hi SpecialKey ctermfg=DarkGray ctermbg=Black cterm=NONE
  hi SpellBad ctermfg=LightGray ctermbg=Black cterm=undercurl ctermul=Red
  hi SpellCap ctermfg=LightGray ctermbg=Black cterm=undercurl ctermul=Yellow
  hi SpellLocal ctermfg=LightGray ctermbg=Black cterm=undercurl ctermul=LightGreen
  hi SpellRare ctermfg=LightGray ctermbg=Black cterm=undercurl ctermul=Cyan
  hi Statement ctermfg=LightGray ctermbg=Black cterm=bold
  hi StatusLine ctermfg=DarkGray ctermbg=LightGray cterm=NONE
  hi StatusLineNC ctermfg=LightGray ctermbg=DarkGray cterm=bold
  ...
  hi Underlined ctermfg=LightGray ctermbg=Black cterm=underline
  hi Visual ctermfg=LightGray ctermbg=DarkGray cterm=NONE
  hi WarningMsg ctermfg=Yellow ctermbg=Black cterm=NONE
  hi debugBreakpoint ctermfg=White ctermbg=DarkRed cterm=NONE
  hi debugPC ctermfg=White ctermbg=DarkCyan cterm=NONE
  hi lCursor ctermfg=Black ctermbg=LightGray cterm=NONE
