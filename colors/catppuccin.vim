...
if &background == 'dark'
  ...
  hi CurSearch guifg=#cdd6f4 guibg=#89556b guisp=NONE gui=NONE ctermfg=126 ctermbg=189 cterm=reverse term=reverse
...
if &background == 'light'
  ...
  hi CurSearch guifg=#4c4f69 guibg=#fc8fc3 guisp=NONE gui=NONE ctermfg=211 ctermbg=236 cterm=reverse term=reverse
