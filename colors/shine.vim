...
" License:      Same as Vim
" Last Updated: Wed Nov  3 11:54:51 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi Number guifg=#ffafaf guibg=NONE gui=NONE cterm=NONE
  ...
  hi Comment guifg=#00008b guibg=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  ...
  hi Number ctermfg=217 ctermbg=NONE cterm=NONE
  hi! link Float Number
...
if s:t_Co >= 16
  ...
  hi StatuslineTerm ctermfg=0 ctermbg=10 cterm=bold
  ...
  hi NonText ctermfg=12 ctermbg=15 cterm=NONE
  hi SpecialKey ctermfg=12 ctermbg=NONE cterm=NONE
  ...
  hi MatchParen ctermfg=15 ctermbg=9 cterm=NONE
  ...
  hi StorageClass ctermfg=9 ctermbg=NONE cterm=bold
...
" Color: DarkGrey    #767676        243            8
" Color: MediumGrey  #A8A8A8        248            8
" Color: LightGrey   #DADADA        253            7
" Color: White       #ffffff        231            15
" Color: Cyan        #00ffff        51             14
" Color: Magenta     #ff00ff        201            13
" Color: Red         #ff0000        196            9
" Color: Yellow      #ffff00        226            11
" Color: SeaGreen    #2e8b57        29             2
" Color: DarkBlue    #00008b        18             4
" Color: DarkCyan    #008b8b        30             6
" Color: DarkGreen   #006400        22             2
" Color: DarkOrange  #ff8c00        208            3
" Color: DarkRed     #8b0000        88             1
" Color: LightBlue   #add8e6        153            12
" Color: LightGreen  #90ee90        120            10
" Color: LightMagenta#ff83fa        213            13
" Color: LightRed    #ffafaf        217            9
" Color: MutedRed    #a07070        95             1
" Color: MutedYellow #ffff60        228            11
" Color: Purple      #6a0dad        55             5
