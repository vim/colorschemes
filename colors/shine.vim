...
" Last Updated: 12.09.2020 14:23:22
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  hi EndOfBuffer guifg=#bcbcbc guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi StatuslineTerm guifg=#87af87 guibg=NONE guisp=NONE gui=bold,reverse cterm=bold,reverse
  hi StatuslineTermNC guifg=#87af87 guibg=NONE guisp=NONE gui=reverse cterm=reverse
  hi VertSplit guifg=NONE guibg=NONE guisp=NONE gui=reverse ctermfg=NONE ctermbg=NONE cterm=reverse
  hi Pmenu guifg=#000000 guibg=#dadada guisp=NONE gui=NONE cterm=NONE
  ...
  hi PmenuThumb guifg=NONE guibg=#dadada guisp=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#000000 guibg=#bcbcbc guisp=NONE gui=underline cterm=underline
  ...
  hi ToolbarLine guifg=NONE guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  hi ToolbarButton guifg=NONE guibg=#bcbcbc guisp=NONE gui=bold cterm=bold
  ...
  hi Folded guifg=#6c6c6c guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  ...
  hi CursorLine guifg=NONE guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  hi CursorColumn guifg=NONE guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  hi CursorLineNr guifg=NONE guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  hi QuickFixLine guifg=NONE guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  hi SignColumn guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  hi Underlined guifg=#af5fd7 guibg=NONE guisp=NONE gui=underline cterm=underline
  ...
  hi WarningMsg guifg=#af5fd7 guibg=#ffffff guisp=NONE gui=NONE cterm=NONE
  ...
  hi Question guifg=#af87af guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Search guifg=#ffffff guibg=#af5fd7 guisp=NONE gui=NONE cterm=NONE
  ...
  hi ColorColumn guifg=NONE guibg=#e4e4e4 guisp=NONE gui=NONE cterm=NONE
  hi Cursor guifg=#ffffff guibg=#000000 guisp=NONE gui=NONE cterm=NONE
  hi lCursor guifg=#000000 guibg=#af87af guisp=NONE gui=NONE cterm=NONE
  hi DiffAdd guifg=NONE guibg=#d7ffd7 guisp=NONE gui=NONE cterm=NONE
  hi DiffChange guifg=NONE guibg=#ffffd7 guisp=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=#6c6c6c guibg=#ffd7d7 guisp=NONE gui=NONE cterm=NONE
  hi DiffText guifg=#000000 guibg=#ffd787 guisp=NONE gui=NONE cterm=NONE
  hi SpellBad guifg=#d70000 guibg=NONE guisp=#d70000 gui=undercurl cterm=undercurl
  hi SpellCap guifg=#af87af guibg=NONE guisp=#af87af gui=undercurl cterm=undercurl
  hi SpellLocal guifg=#87af5f guibg=NONE guisp=#87af5f gui=undercurl cterm=undercurl
  hi SpellRare guifg=#87af87 guibg=NONE guisp=#87af87 gui=undercurl cterm=undercurl
  hi Identifier guifg=#5fafaf guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#87af5f guibg=NONE guisp=NONE gui=bold cterm=bold
  hi Constant guifg=#af87af guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi PreProc guifg=#af5fd7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Special guifg=#d75f87 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi SpecialChar guifg=#6c6c6c guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Tag guifg=#af5fd7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Type guifg=#87af87 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Operator guifg=#af5fd7 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Directory guifg=#5fafaf guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi Title guifg=#87af5f guibg=NONE guisp=NONE gui=bold cterm=bold
  unlet s:t_Co
  finish
endif
