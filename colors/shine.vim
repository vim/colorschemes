...
" License:      Same as Vim
" Last Updated: Wed Oct 20 12:44:08 2021
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#ffffff', '#87af5f', '#af87af', '#af5fd7', '#5fafaf', '#87af87', '#d75f87', '#bcbcbc', '#6c6c6c', '#87af5f', '#af87af', '#af5fd7', '#5fafaf', '#87af87', '#d75f87', '#000000']
  ...
  hi StatuslineNC guifg=#bcbcbc guibg=#4e4e4e gui=NONE cterm=NONE
  hi StatuslineTerm guifg=#ffffff guibg=#87af5f gui=bold cterm=bold
  hi StatuslineTermNC guifg=#bcbcbc guibg=#87af87 gui=NONE cterm=NONE
  hi VertSplit guifg=#bcbcbc guibg=#4e4e4e gui=NONE cterm=NONE
  ...
  hi Error guifg=#ffffff guibg=#d70000 gui=reverse cterm=reverse
  hi ErrorMsg guifg=#ffffff guibg=#d70000 gui=reverse cterm=reverse
...
if s:t_Co >= 256
  ...
  hi StatuslineNC ctermfg=250 ctermbg=239 cterm=NONE
  hi StatuslineTerm ctermfg=231 ctermbg=107 cterm=bold
  hi StatuslineTermNC ctermfg=250 ctermbg=108 cterm=NONE
  hi VertSplit ctermfg=250 ctermbg=239 cterm=NONE
  ...
  hi Error ctermfg=231 ctermbg=160 cterm=reverse
  hi ErrorMsg ctermfg=231 ctermbg=160 cterm=reverse
...
if s:t_Co >= 16
  ...
  hi StatuslineTermNC ctermfg=7 ctermbg=2 cterm=NONE
  ...
  hi MoreMsg ctermfg=0 ctermbg=15 cterm=NONE
  hi ModeMsg ctermfg=0 ctermbg=15 cterm=NONE
  hi Question ctermfg=13 ctermbg=NONE cterm=NONE
  hi Todo ctermfg=0 ctermbg=11 cterm=NONE
  hi MatchParen ctermfg=15 ctermbg=1 cterm=NONE
  ...
  hi SpecialChar ctermfg=8 ctermbg=NONE cterm=NONE
...
" Background: light
" Color: comment     #6c6c6c        242            8
" Color: constant    #af87af        139            13
" Color: identifier  #5fafaf        73             6
" Color: statement   #87af5f        107            2
" Color: preproc     #af5fd7        134            5
" Color: type        #87af87        108            2
" Color: special     #d75f87        168            1
" Color: storage     #d70000        160            9
" Color: fg0         #000000        16             0
" Color: bg0         #ffffff        231            15
" Color: bg1         #bcbcbc        250            7
" Color: bg2         #4e4e4e        239            8
" Color: visual      #d0d0d0        252            7
" Color: folded      #e4e4e4        254            0
